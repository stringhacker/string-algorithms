...
Zauważmy, że w każdym momencie, pozycje na stosie są uporządkowane od największej na szczycie stosu.
...
Ponieważ $LCP[i_{j + 2}] > LCP[i_{j + 1}]$ i $w[i_{j} ... i_{j} + LCP[i_{j + 1}] - 1]$
 ...
 to pierwiaski pierwotne tych dwóch okresów powinne się synchronizować.
