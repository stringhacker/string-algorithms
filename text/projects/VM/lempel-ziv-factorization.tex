...
Aby zrozumieć co to jest, weźmy dowolne słowo $m$ będące prefiksem $w[i..n]$.
Jeśli $m$ jest najdłużsym czynnikiem poprzednim,
to musi ono być najdłużsym podsłowem słowa $w[1..i + |m| - 1]$ spośród wszystkich możliwych prefiksów.
