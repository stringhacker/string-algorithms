...
Ponieważ najwięsze wspólne prefiksy pomiędzy sufiksami $\SA_{n}$, to jest po prostu tablica LCP.
Aby dowieść tezę, wystarczy pokazać, że przejście od $\SA_{i}$ do $\SA_{i - 1}$ zawiera równoważne przejście w tablicy LCP.
